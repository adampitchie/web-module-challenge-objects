...
const sandwich = createMenuItem('sandwich', 12, 'lunch');
const burrito = createMenuItem('burrito', 14, 'lunch');
console.log(pizza);
...
*/
reviews.push({name: 'Adam', rating: 4, feedack: 'this is my review'});
console.log(reviews);
...
function getReviewByIndex(array, index) {
  ...
  return `${value.name} gave the restaurant a ${value.rating} star review, and their feedback was: ${value.feedback}`
}
